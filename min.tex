...
with tensor product of Pauli elements. % Reference
...
%This research demonstrates the proper mapping of Pauli terms from their symplectic representation to the coefficient matrix and its fast composition to the matrix form. 
...
%By using the mapping from the symplectic representation of Pauli terms and the coefficient matrix, we can manipulate Pauli terms more efficiently in the matrix vector space.
