...
With coefficient elements and their indexes on the matrix,
...
tensorized decomposition algorithm suggested by Hantzko et al\cite{hantzko_tensorized_2023}.
...
in the polynomial, it is more efficient than previous term-by-term construction methods, which have 
$8^n + 2^n (f(n)-2^n)$ and $2*4^n$.
\end{abstract}
